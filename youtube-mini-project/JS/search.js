  let data = JSON.parse(localStorage.getItem('saveitems'));
  data = data[0];
  ...
  const displaycontent = (data) =>{
    ...
    maindiv.innerHTML = null;
      data.forEach(({id:{videoId},snippet:{title,thumbnails:{high:{url}},channelTitle,description}})=>{
          ...
          channelinfo.append(channeltitle,views,desc);
